...
// 	Repository: gitlab.ozon.ru/platform/fork-googleapis
// 	Filepath: google/api/visibility.proto
// 	Version: master
...
func file_google_api_visibility_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_api_visibility_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_api_visibility_proto_msgTypes[1].Exporter = func(v any, i int) any {
